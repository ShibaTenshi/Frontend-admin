...
import { defineComponent, ref, computed, onMounted, onUnmounted, h as h$2, Fragment, watchEffect, watch, provide, inject, Teleport, reactive, unref, normalizeClass, useSSRContext, withAsyncContext, withCtx, createVNode, createTextVNode, toDisplayString, cloneVNode, nextTick, toRef, shallowRef, resolveComponent, mergeProps, renderSlot, openBlock, createBlock, createCommentVNode } from 'vue';
import { m as modal, u as useUI, _ as __nuxt_component_0 } from './Button-2160abdc.mjs';
import { m as mergeConfig, b as appConfig, n as navigateTo, a as useRuntimeConfig, _ as _export_sfc } from '../server.mjs';
import { ssrRenderComponent, ssrRenderAttr, ssrInterpolate, ssrRenderList, ssrRenderStyle, ssrRenderClass, ssrRenderSlot } from 'vue/server-renderer';
import { _ as __nuxt_component_2, a as __nuxt_component_3 } from './FormGroup-57c80e67.mjs';
import { _ as __nuxt_component_1$1 } from './Input-55cd4d73.mjs';
                  ...
                  if (_push4) {
                    _push4(ssrRenderComponent(_component_HDialogPanel, {
                      class: [
                        ...
                        _ctx.ui.ring,
                        _ctx.ui.shadow,
                        _ctx.fullscreen ? "w-screen" : _ctx.ui.width,
                        _ctx.fullscreen ? "h-screen" : _ctx.ui.height,
                        _ctx.fullscreen ? "rounded-none" : _ctx.ui.rounded,
                        _ctx.fullscreen ? "m-0" : _ctx.ui.margin
                      ]
                    }, {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    if (!restaurantId.value)
      navigateTo("/");
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch(runtime.public.API_URL + "/admin/unapproved", {
      params: {
        tokenId: useCookie("token"),
        id: restaurantId
      }
    }, "$ddrKHTXx8q")), __temp = await __temp, __restore(), __temp);
    const record = data.value;
    let error;
    const { data: logo } = ([__temp, __restore] = withAsyncContext(() => useFetch(runtime.public.STORAGE_URL + "/restaurant/image/logo/" + record.restaurantName, "$B8jTrrXDVy")), __temp = await __temp, __restore(), __temp);
    const logoLink = runtime.public.STORAGE_URL + logo.value;
    const { data: envLink } = ([__temp, __restore] = withAsyncContext(() => useFetch(runtime.public.STORAGE_URL + "/restaurant/image/env/" + record.restaurantName, "$vnIRufEzau")), __temp = await __temp, __restore(), __temp);
    const { data: menuLink } = ([__temp, __restore] = withAsyncContext(() => useFetch(runtime.public.STORAGE_URL + "/restaurant/image/menu/" + record.restaurantName, "$e6IOEqI2mD")), __temp = await __temp, __restore(), __temp);
    ...
    async function submit(event) {
      await useFetch(runtime.public.API_URL + "/admin/discard", {
        method: "post",
        body: {
          tokenId: useCookie("token"),
          id: record.id,
    ...
    async function approve() {
      await useFetch(runtime.public.API_URL + "/admin/approve", {
        method: "post",
        body: {
          tokenId: useCookie("token"),
          id: record.id
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Head, null, {
        default: withCtx((_2, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<title${_scopeId}>Restaurant Info - Shibaqueue Admin</title>`);
          } else {
            return [
              createVNode("title", null, "Restaurant Info - Shibaqueue Admin")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`<div class="p-10 my-14"><div class="flex justify-center"><img${ssrRenderAttr("src", logoLink)} class="w-[200px]"></div><div>`);
      _push(ssrRenderComponent(_component_UModal, {
        ...
        default: withCtx((_2, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", modalLink.value)}${_scopeId}>`);
          } else {
            return [
              createVNode("img", { src: modalLink.value }, null, 8, ["src"])
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_UModal, {
        modelValue: cancelRestaurant.value,
        "onUpdate:modelValue": ($event) => cancelRestaurant.value = $event
      }, {
        default: withCtx((_2, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UForm, {
              ...
              default: withCtx((_22, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_UInput, {
                          modelValue: state.value.reason,
                          "onUpdate:modelValue": ($event) => state.value.reason = $event
                  ...
                  _push3(`<br${_scopeId2}><h1 class="text-red-500 text-sm text-center"${_scopeId2}>${ssrInterpolate(unref(error))}</h1><br${_scopeId2}>`);
                  ...
                  return [
                    ...
                    createVNode("br"),
                    createVNode("h1", { class: "text-red-500 text-sm text-center" }, toDisplayString(unref(error)), 1),
                    createVNode("br"),
      ...
      _push(`</div><div class="flex justify-center p-5"><h1 class="text-3xl font-bold">${ssrInterpolate(unref(record).restaurantName)}</h1></div><div class="flex justify-center p-5"><h1 class="text-sm font-bold">${ssrInterpolate(unref(record).dateAdded)}</h1></div><div class="flex justify-center p-5"><h1 class="text-sm font-bold">Category: ${ssrInterpolate(unref(record).category)}</h1></div><div class="flex justify-center p-16"><a class="text-gray-500">${ssrInterpolate(unref(record).description)}</a></div><div class="flex justify-center py-3"><h1 class="text-2xl font-bold text-primary">Restaurant Environments</h1></div><div class="grid grid-cols-3 gap-5 w-[90%] m-auto"><!--[-->`);
      ssrRenderList(unref(envLink), (link) => {
        _push(`<img${ssrRenderAttr("src", unref(runtime).public.STORAGE_URL + link)} class="w-[500px]">`);
      });
      _push(`<!--]--></div><br><br><div class="flex justify-center py-3"><h1 class="text-2xl font-bold text-primary">Restaurant Menus</h1></div><div class="grid grid-cols-3 gap-5 w-[90%] m-auto"><!--[-->`);
      ssrRenderList(unref(menuLink), (link) => {
        _push(`<img${ssrRenderAttr("src", unref(runtime).public.STORAGE_URL + link)}>`);
      });
      _push(`<!--]--></div><br><br><div class="p-5"><h1 class="text-2xl font-bold text-primary text-center">Open Date</h1><div></div><div class="flex justify-center"><h1 class="p-5" style="${ssrRenderStyle(unref(record).openDate[0] == 1 ? "color: black" : "color: lightgray")}">Sunday</h1><h1 class="p-5" style="${ssrRenderStyle(unref(record).openDate[1] == 1 ? "color: black" : "color: lightgray")}">Monday</h1><h1 class="p-5" style="${ssrRenderStyle(unref(record).openDate[2] == 1 ? "color: black" : "color: lightgray")}">Tuesday</h1><h1 class="p-5" style="${ssrRenderStyle(unref(record).openDate[3] == 1 ? "color: black" : "color: lightgray")}">Wednesday</h1><h1 class="p-5" style="${ssrRenderStyle(unref(record).openDate[4] == 1 ? "color: black" : "color: lightgray")}">Thursday</h1><h1 class="p-5" style="${ssrRenderStyle(unref(record).openDate[5] == 1 ? "color: black" : "color: lightgray")}">Friday</h1><h1 class="p-5" style="${ssrRenderStyle(unref(record).openDate[6] == 1 ? "color: black" : "color: lightgray")}">Saturday</h1></div><div class="flex justify-center"><h1 class="p-5">Open Time: ${ssrInterpolate(unref(record).openTime)}</h1><h1 class="p-5">Close Time: ${ssrInterpolate(unref(record).closeTime)}</h1></div></div><div class="p-5"><h1 class="text-2xl font-bold text-primary text-center p-5">Owner</h1><h1 class="text-center">Owner Name: ${ssrInterpolate(unref(record).ownerName)}</h1><h1 class="text-center">User Name: ${ssrInterpolate(unref(record).username)}</h1><h1 class="text-center">Owner Name: ${ssrInterpolate(unref(record).email)}</h1></div><div class="flex justify-around p-5">`);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/restaurant/info.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=info-eeb804b8.mjs.map
